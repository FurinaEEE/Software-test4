 ...
 * 
 */
@WebServiceClient(name = "WeatherWS", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/C:/bianyiqi/other/WeatherWS.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/bianyiqi/other/WeatherWS.xml");
